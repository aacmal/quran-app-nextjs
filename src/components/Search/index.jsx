...
const Search = ({className}) => {
  ...
  const [filteredChapters, setFilteredChapters] = useState([{name_simple: "Ketik untuk mencari"}])
  ...
  return (
    <div className='relative'>
      <input onFocus={() => setExpanded(true)} onBlur={handleBlur} onChange={(e) => handleChange(e)} type="text" className={'bg-gray-100 w-full dark:bg-slate-600 dark:text-slate-200 dark:ring-emerald-500 py-2 px-3 my-3 rounded-lg outline-none focus:ring-2 ring-emerald-300 transition-all ' + className} placeholder='/ Cari'/>
      {
        isExpanded &&
