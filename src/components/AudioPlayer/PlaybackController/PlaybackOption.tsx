        ...
        {location === 'main' ? (
          <>
            <div
              ...
              onClick={() => setLocation('recitations')}
            >
            ...
            <Link
              download={true}
              target="_blank"
              href={`https://download.quranicaudio.com/qdc/mishari_al_afasy/murattal/${audioId}.mp3`}
            >
            ...
            {recitations.map((e) => (
              <div key={e.id}>
                <div
                  ...
                  onClick={() =>
                    dispatch({ type: 'changeReciterId', payload: e.id })
                  }
                >
                  {e.reciter_name}
                  {'  '}
