...
const PlaybackOption = () => {
    ...
    return (
        <>
            ...
            <div className={
                    classNames(
                        'p-2 dark:bg-slate-500 rounded-md w-52 absolute bottom-14 right-0 translate-x-9 transform transition-all',
                        {"opacity-0 invisible translate-y-7": isHidden},
                        {"opacity-100 visible translate-y-0": !isHidden},
                    )}>
                <div className='py-1 px-1 hover:bg-emerald-500 flex items-center rounded text-slate-100 cursor-pointer'>
                ...
                <div  
                    className='py-1 px-1 hover:bg-emerald-500 flex items-center rounded text-slate-100 cursor-pointer'
                >
