    ...
    <ul className={classNames("p-2 pl-1 w-44 round h-72 overflow-auto scrollbar-hide")}>
        {
            chapterLists?.map(e => (
                <li
                    ...
                    className="px-2 py-1 cursor-pointer hover:bg-emerald-100 dark:hover:bg-emerald-400 dark:hover:text-slate-100 hover:text-emerald-500 rounded flex items-center">
